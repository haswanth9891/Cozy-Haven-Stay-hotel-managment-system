	...
	public SecurityFilterChain getSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		return http.cors().and().csrf().disable().authorizeHttpRequests()
				.requestMatchers("/api/user/login", "/api/user/register", "/api/hotelowner/login",
						"/api/hotelowner/register","/api/admin/add-admin","/api/admin/login", "/api/hotel/getall",
						...
						"/api/room/availability/{roomId}", "/api/room/calculate-fare-room/{roomId}","/api/reservation/reservation-fare","/swagger-ui/", "/v3/api-docs/**")
